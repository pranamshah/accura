...
-- GST Lines (for Sales/Purchase invoices)
...
-- Inventory Lines (for vouchers with stock movement)
...
CREATE TABLE IF NOT EXISTS tds_sections (
  ...
  threshold_limit NUMERIC(15,2) NOT NULL DEFAULT 0
);
