...
CREATE TABLE IF NOT EXISTS items (
  ...
  is_serial_enabled BOOLEAN DEFAULT FALSE,
  is_active BOOLEAN DEFAULT TRUE,
  description TEXT,
  created_at TIMESTAMPTZ DEFAULT NOW(),
  updated_at TIMESTAMPTZ DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS payroll_entries (
  ...
  year INTEGER NOT NULL,
  working_days NUMERIC DEFAULT 26,
  present_days NUMERIC DEFAULT 26,
...
CREATE INDEX IF NOT EXISTS idx_vouchers_company_type ON vouchers(company_id, type);
...
CREATE INDEX IF NOT EXISTS idx_gst_lines_voucher ON gst_lines(voucher_id);
