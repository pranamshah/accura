...
export default function Page() {
  return (
    <div>
      <PageHeader title="Stock Summary" subtitle="Coming soon - Full implementation available" />
      <div className="p-6">
        <div className="bg-white border border-border-subtle rounded-lg p-8 text-center">
          <p className="text-[14px] font-medium text-text-primary mb-2">Stock Summary</p>
