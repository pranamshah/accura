...
const SECTIONS: { title: string; items: { key: string; label: string; path: string }[] }[] = [
  {
    title: 'MASTERS',
    items: [
      { key: 'C', label: 'Create', path: '/create/ledger' },
      { key: 'A', label: 'Alter', path: '/alter/ledger' },
      { key: 'H', label: 'Chart of Accounts', path: '/display/trial-balance' },
    ],
  },
  {
    title: 'TRANSACTIONS',
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'I', label: 'Import', path: '/banking/import-statement' },
      { key: 'K', label: 'Ask Accura (AI)', path: '/ai/ask' },
      { key: 'X', label: 'Share with CA', path: '/utilities/share-with-ca' },
    ],
  },
  {
    title: 'REPORTS',
    items: [
      ...
      { key: 'M', label: 'Display More Reports', path: '/display/more' },
    ],
  },
];
