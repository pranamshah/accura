...
import {
  ...
  Users, Brain, Settings, Building2, TrendingUp,
  ChevronDown, ChevronRight, Wallet, FileBarChart,
  UserCheck, ShieldCheck, Landmark, X
} from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { label: "Vouchers", icon: <FileText size={16} />, children: [
    ...
    { label: "Payments", href: "/vouchers/PAYMENT", icon: <Wallet size={14} /> },
    { label: "Receipts", href: "/vouchers/RECEIPT", icon: <Receipt size={14} /> },
    { label: "Journal", href: "/vouchers/JOURNAL", icon: <FileText size={14} /> },
    { label: "Contra", href: "/vouchers/CONTRA", icon: <FileText size={14} /> },
  ...
  { label: "Inventory", href: "/inventory", icon: <Package size={16} />, children: [
    ...
    { label: "Godowns", href: "/inventory/godowns", icon: <Building2 size={14} /> },
  ]},
  { label: "Parties", href: "/parties", icon: <Users size={16} /> },
  ...
  { label: "Banking", href: "/banking", icon: <Landmark size={16} /> },
  { label: "Reports", href: "/reports", icon: <FileBarChart size={16} />, children: [
    { label: "Reports", href: "/reports", icon: <FileBarChart size={14} /> },
  ...
  { label: "AI Assistant", href: "/ai", icon: <Brain size={16} />, badge: "AI" },
...
function NavItemComponent({ item, depth = 0 }: { item: NavItem; depth?: number }) {
  ...
  const isActive = item.href
    ? pathname === item.href || (item.href !== "/dashboard" && pathname.startsWith(item.href) && item.href.split("/").length > 1)
    : false;
    ...
    <>
      ...
      >
        ...
        <div className="p-3 border-t border-border-subtle shrink-0">
          <Link
            href="/settings"
            className="flex items-center gap-2 px-3 py-2 text-[12px] text-text-muted hover:text-text-primary hover:bg-row-alt rounded-md"
          >
            <Settings size={14} />
            <span>Settings</span>
          </Link>
