...
const GOTO_ITEMS = [
  ...
  { label: 'Smart Entry', path: '/ai/smart-entry', category: 'Tools', key: 'Alt+I' },
  { label: 'Ask Accura', path: '/ai/ask', category: 'Tools', key: 'Alt+Q' },
  { label: 'Invoices', path: '/invoices', category: 'Tools' },
  { label: 'Anomaly Scanner', path: '/display/anomaly-scanner', category: 'Tools' },
  { label: 'Banking', path: '/banking', category: 'Banking' },
  { label: 'Bank Reconciliation', path: '/banking/reconciliation', category: 'Banking' },
  { label: 'Import Bank Statement', path: '/banking/import-statement', category: 'Banking' },
  { label: 'Share with CA', path: '/utilities/share-with-ca', category: 'Tools', key: 'Alt+M' },
